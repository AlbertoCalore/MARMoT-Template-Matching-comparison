...
for (i in 1:10) {
  ...
  path = paste0("../Scenarios/Scenario_1/seed", sep = as.character(i), ".rda") #<--------
  ...
  path_left = paste0("../Scenarios/Scenario_2/seed", sep = as.character(i), ".rda") #<--------
  save(scenario, file = path_left)
  rm.gc(scenario)
  
  scenario = rm.right(scenario1, rm_right_trt)
  path_right = paste0("../Scenarios/Scenario_3/seed", sep = as.character(i), ".rda") #<--------
