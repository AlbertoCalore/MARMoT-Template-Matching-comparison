...
for (i in 1:10) {
  ...
  path = paste0("../Scenarios/Scenario_4/seed", sep = as.character(i), ".rda") #<--------
  ...
  path_left = paste0("../Scenarios/Scenario_5/seed", sep = as.character(i), ".rda") #<--------
  save(scenario, file = path_left)
  rm.gc(scenario)
  
  scenario = rm.right(scenario1, rm_right_trt)
  path_right = paste0("../Scenarios/Scenario_6/seed", sep = as.character(i), ".rda") #<--------
